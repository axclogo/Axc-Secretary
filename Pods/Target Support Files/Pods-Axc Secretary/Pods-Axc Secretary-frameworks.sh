...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AxcDrawPath_Tool/AxcDrawPath_Tool.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DZNSegmentedControl/DZNSegmentedControl.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FBDigitalFont/FBDigitalFont.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JWNetAutoCache/JWNetAutoCache.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WMDragView/WMDragView.framework"
